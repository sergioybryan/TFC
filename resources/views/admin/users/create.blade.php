...
<body>
	<div class="container-fluid">
		...
		<div class="row" >
			<div class="col-md-4 offset-md-4 pt-3 pb-4 mt-3 mb-5 formu justify-content-center bg-dark">
				<form action="AdminUsersController@store" method="POST">
					<h5 class="text-center">¡Bienvenido a Matrix!</h5><h5>¡ups! perdón, a</h5> <h5 class="text-center">Diversa Electronics.</h5>
					...
					<div class="form-group">
						...
						<input type="email" class="form-control" name="email_verified_at">
					</div>
