	...
	<div class="container-fluid">
		<div class="row-fluid mb-5">
			<nav class="navbar cabecera navbar-expand-md navbar-dark bg-dark">
				...
				<ul class="navi">
					<li><a class="nav-link neon categoria" href="#">{{$nombre}}</a>
						<ul>
...
<!-----------------------  C A B E C E R A ------------------------------->
		...
		<div class=" row align-items-center cuerpo justify-content-center no-gutters ">
			...
			<div class=" row align-items-center justify-content-center ">	
				<div class="col-lg-12 pt-3 pb-3 mt-5 mb-5 formu cabecera rounded col-lg-3">
                    
                    
                                     
               {!! Form::open(['method' => 'POST', "action" => ['Auth\RegisterController@update',$id]]) !!}
					...
					<input id="password" value="{{$contra}}" type="password" class="form-control @error('password') is-invalid @enderror" name="password" readonly>                    </div>
