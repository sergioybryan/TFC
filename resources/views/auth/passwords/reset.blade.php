            ...
            <div class="row">
				<div class="col-md-4 offset-md-4 pt-3 pb-4 mt-5 mb-5 formu justify-content-center bg-dark">
                    <form method="POST" action="{{ route('password.update') }}">
						...
						<p class="text-center"> Ahora puedes actualizar tu contraseña, recuerda que es imprescindible para acceder con tu usuario por lo que debería ser una que puedas recordar facilmente.</p>
