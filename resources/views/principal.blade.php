...
<link rel="stylesheet" type="text/css" href="../public/css/ddsmoothmenu.css" />

<script type="text/javascript" src="../public/js/jquery.min.js"></script>
<script type="text/javascript" src="../public/js/ddsmoothmenu.js">
...
<div id="templatemo_wrapper">
	...
	<div id="templatemo_header">
        ...
        <div id="header_right">
        	<p>
	        <a href="admin/users/create">Registro</a> | <a href="#">Entrar</a></p>
            <p>
    ...
    <div id="templatemo_menubar">
    	<div id="top_nav" class="ddsmoothmenu">
            <ul>
                ...
                <li><a href="products.html" class="selected">Todas las Categorías</a>
                    <ul>
                        <li><a href="#submenu1">Electrónica</a></li>
                        <li><a href="#submenu2">Informática</a></li>
                        <li><a href="#submenu3">Videojuegos</a></li>
                        <li><a href="#submenu4">Telefonía</a></li>
                        <li><a href="#submenu5">Hogar</a></li>
                  </ul>
                </li>
                <li><a href="about.html">Sobre Nosotros</a>
                    <ul>
                        <li><a href="#submenu1">Bryan Toapanta</a></li>
                        <li><a href="#submenu2">Sergio Pérez</a></li>
                  </ul>
                </li>
        	...
        	<div class="sidebar_box"><span class="bottom"></span>
                ...
                <div class="content"> 
                	<ul class="sidebar_list">
                    	<li class="first"><a href="#">Electrónica</a></li>
