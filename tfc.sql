...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-04-2020 a las 16:34:43
...
(6, '2020_04_29_171221_create_roles_table', 1);
...
(1, 1, 'Administrador', 'administrador@gmail.com', NULL, 'Administrador_69', NULL, NULL, NULL);
...
ALTER TABLE `users`
  ...
  ADD KEY `users_rol_id_index` (`rol_id`);
